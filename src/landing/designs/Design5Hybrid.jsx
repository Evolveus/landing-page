...
// ─── Hero visual — floating cards in D5 palette ───────────────
function HeroVisual() {
  const y = useScrollY();
  return (
        ...
        <div className="d5-split-hero-inner">
          ...
          <div className="d5-split-hero-text">
            ...
            <p className="d5-split-hero-lede">
              Evolveus is a complete digital assessment platform — coding
              evaluation, proctoring, AI-assisted grading, and analytics — built
              for daily use by faculty, semester managers, and administrators.
            </p>
          ...
          <Reveal>
            <div className="d5-section-head">
              ...
              <p className="d5-section-sub">
                Evolveus replaces the fragmented stack of tools institutions use
                today — question banks in spreadsheets, exams in proctored
                portals, grading in manual scripts — with a single coherent
                platform.
              </p>
            </div>
          </Reveal>
        ...
        <div className="d5-section-inner">
          <Reveal>
            <div className="d5-section-head d5-section-head-light">
              <div className="d5-eyebrow d5-eyebrow-light">
                CHAPTER TWO · CODING ASSESSMENT
              </div>
              <h2 className="d5-h2 d5-h2-light">
                Code is submitted.
                <br />
                <span className="d5-italic">Marks are awarded</span> —
                instantly.
              </h2>
            </div>
          </Reveal>
          <div className="d5-coding-grid">
            <Reveal>
              <div className="d5-coding-prose">
                <p>
                  Faculty configure the test cases — visible demonstrations and
                  hidden edge cases. Evolveus compiles each submission, executes
                  it in an isolated sandbox under enforced time and memory
                  limits, and verifies output against expected results.
                </p>
                <p>
                  Partial marking distributes credit proportionally. A student
                  who passes four of five test cases receives four-fifths of the
                  marks — fairly, and without any manual review.
                </p>
                <p className="d5-coding-quote">
                  Faculty design problems. Evolveus runs every submission —
                  instantly, consistently, without bias.
                </p>
              </div>
            </Reveal>
            <Reveal delay={120}>
              <div className="d5-coding-card">
                <div className="d5-cc-tag">
                ...
                <div className="d5-cc-tests">
                  {[
                    ...
                    <div key={t.id} className={`d5-cc-tc d5-cc-${t.s}`}>
                      <Icon
                        name={t.s === "pass" ? "check" : "alert"}
                        size={13}
                        className="d5-cc-tc-icon"
                      />
              ...
              {[
                {
                  i: "cpu",
                  t: "Sandboxed",
                  d: "Isolated containers with time and memory limits",
                },
                {
                  i: "eye",
                  t: "Hidden tests",
                ...
                },
                {
                  i: "gauge",
                  t: "Partial marks",
                  d: "Proportional scoring by cases passed",
                },
                {
                  i: "fileText",
                  t: "Boilerplate",
                ...
                },
                {
                  i: "globe",
                  t: "7 languages",
                  d: "Python, Java, C++, JS, C, Octave, Scala",
                },
                {
                  i: "clock",
                  t: "Per-question limits",
                  d: "Time and memory configurable individually",
                },
              ].map((f) => (
          ...
          <div className="d5-formats-grid">
            <Reveal>
              <div className="d5-format-col">
                ...
                <p className="d5-section-sub">
                  Mix any combination within a single exam. Configure marks,
                  negative marks, difficulty, Bloom's level, and CO mapping per
                  question.
                </p>
                <ol className="d5-q-list">
                  {QTYPES.map((q, i) => (
                    <li key={q}>
                      <span className="d5-q-num">
            ...
            <Reveal delay={120}>
              <div className="d5-format-col">
                ...
                <p className="d5-section-sub">
                  The core evaluation engine handles automated scoring across
                  all question types. AI-assisted grading for descriptive
                  answers and fill-in-the-blank.
                </p>
                <div className="d5-eval-list">
                  {[
                    {
                      t: "MCQ partial marking",
                      d: "Configurable per quiz; full or proportional credit",
                    },
                    {
                      t: "Negative marking",
                      d: "Fixed value or percentage; global or per-question",
                    },
                    {
                      t: "Coding partial marks",
                      d: "Test-case ratio multiplied by max marks",
                    },
                    {
                      t: "AI fill-in-blank",
                      d: "Synonym and semantic equivalence accepted",
                    },
                    {
                      t: "Descriptive AI grading",
                      d: "Faculty supplies criteria; AI scores accordingly",
                    },
                    {
                      t: "Manual override",
                      d: "Faculty can adjust any score post-evaluation",
                    },
                  ].map((e) => (
        ...
        <div className="d5-section-inner">
          <Reveal>
            <div className="d5-section-head">
              ...
              <p className="d5-section-sub">
                Evolveus enforces controlled exam environments. Suspicious
                actions are detected, timestamped, and surfaced in audit reports
                for academic review.
              </p>
            </div>
          </Reveal>
                ...
                {[
                  {
                    ...
                    d: "Blocks exam progression unless fullscreen mode is active",
                  },
                  {
                    i: "lock",
                    t: "Kiosk Mode",
                  ...
                  },
                  {
                    i: "key",
                    t: "Password Gate",
                    d: "Optional access password configured per exam",
                  },
                  {
                    i: "refresh",
                    t: "Continuous Sync",
                    d: "Answers saved continuously; resilient to disconnection",
                  },
                  {
                    i: "rss",
                    t: "Audit Logs",
                    d: "Track faculty actions, exam edits, and score overrides",
                  },
                ].map((e) => (
            ...
            {[
              {
                i: "edit",
                t: "Rich-text editor",
                d: "Bold, italic, lists, code blocks, quotes, horizontal rules.",
              },
              {
                i: "bookOpen",
                t: "LaTeX support",
                d: "Mathematical and scientific notation in question content.",
              },
              {
                i: "upload",
                t: "Image embedding",
                d: "Inline images in questions; signed access links.",
              },
              {
                i: "download",
                t: "File submissions",
                d: "Accept student file uploads where permitted by question type.",
              },
              {
                i: "tag",
                t: "Bloom's taxonomy",
                d: "Tag every question — Remember, Understand, Apply, Analyze, Evaluate, Create.",
              },
              {
                i: "flag",
                t: "CO mapping",
                d: "CO1 through CO8 alignment for accreditation reports.",
              },
              {
                i: "database",
                t: "Bulk MCQ upload",
                d: "Spreadsheet import with row-level validation and templates.",
              },
              {
                i: "share",
                t: "Bank sharing",
                d: "Share question banks with controlled access; revoke at any time.",
              },
            ].map((c, i) => (
        ...
        <div className="d5-section-inner">
          <Reveal>
            ...
            <p className="d5-cta-sub">
              Schedule a demonstration with our team. Self-hosted deployment
              options available for institutions that require data sovereignty.
            </p>
