...
const DEPLOY_MODES = {
  ...
  self: {
    ...
    features: [
      ...
      {
        icon: "network",
        t: "SSO & LMS integration",
        d: "Connect to your existing identity provider or learning management system",
      },
      {
        icon: "shieldCheck",
        t: "Compliance-ready",
        ...
        <Reveal>
          <div className="d5-section-head">
            ...
            <p className="d5-section-sub">
              ...
              maintenance, updates, and support. You never manage the platform
              itself — just your assessments.
            </p>
          </div>
        </Reveal>
        ...
        <div className="d5-split-hero-inner">
          <div className="d5-split-hero-text">
            ...
            <p className="d5-split-hero-lede">
              ...
              and performance analytics. Built for day-to-day use by every role
              in your institution.
            </p>
        ...
        <div className="d5-section-inner">
          <Reveal>
            <div className="d5-section-head">
              ...
              <p className="d5-section-sub">
                ...
                Faculty review and confirm. Every score is auditable,
                adjustable, and in your control.
              </p>
            </div>
          </Reveal>
          ...
          <div className="d5-ai-grid">
            ...
            <div>
              ...
              <div className="d5-byok">
                ...
                <div className="d5-byok-note">
                  ...
                  />
                  API keys are stored securely on your deployment. Student
                  responses are only sent to your configured provider during
                  evaluation — never to Evolveus servers.
                </div>
              </div>
            </div>
            ...
            <div className="d5-ai-prose">
              <p>
                Descriptive questions test reasoning, articulation, and depth —
                but grading them at scale is a burden that limits how often
                faculty can use them. Evolveus removes that barrier.
              </p>
              <p>
                Faculty define what a good answer looks like. The connected LLM
                evaluates each student response against that rubric, returning a
                score with transparent reasoning. Faculty review the result,
                adjust where needed, and publish when ready.
              </p>
              <p>
                Fill-in-the-blank questions benefit from the same AI layer —
                accepting semantically equivalent phrases, not just exact text
                matches. A student who writes "gradient descent" when the answer
                is "steepest descent" gets the credit they deserve.
              </p>
            ...
            <Reveal>
              <div className="d5-coding-prose">
                <p>
                  ...
                  compiles each submission in an isolated sandbox under enforced
                  time and memory limits, verifies output, and scores
                  proportionally.
                </p>
                <p>
                  Partial marking distributes credit by test cases passed. A
                  student who clears four of five cases receives four-fifths of
                  the marks — consistently, without manual review.
                </p>
                <p className="d5-coding-quote">
                  Faculty design the problem. Evolveus runs every submission —
              ...
              {[
                {
                  i: "cpu",
                  t: "Sandboxed",
                  d: "Isolated containers, time + memory limits",
                },
                {
                  i: "eye",
                  t: "Hidden test cases",
                ...
                },
                {
                  i: "gauge",
                  t: "Partial marking",
                  d: "Proportional by cases passed",
                },
                {
                  i: "fileText",
                ...
                },
                {
                  ...
                  d: "Time and memory per question",
                },
              ].map((f) => (
