    ...
    <div className="page p1">
      ...
      <div className="p1-stage">
        <div className="p1-left">
          ...
          <p className="p1-lede">
            One platform for every exam your institution runs — authored, proctored,
            graded, and analysed by intelligence designed for the way faculty actually work.
          </p>

          <div className="p1-meta">
            <div className="p1-meta-row">
              <span className="p1-meta-key">A brochure on</span>
              <span className="p1-meta-val">AI-driven assessment for higher education</span>
            </div>
            <div className="p1-meta-row">
        ...
        <div className="p1-scr-body">
          ...
          <div className="p1-scr-rubric">
            <div className="p1-rub-row">
              <span className="p1-rub-tick" data-state="ok">✓</span>
            ...
            <div className="p1-rub-row">
              <span className="p1-rub-tick" data-state="warn">~</span>
          ...
          <div className="p1-scr-foot">
            ...
            <div className="p1-scr-total"><span>Score</span><strong>7 / 10</strong></div>
          </div>
        </div>
      </div>
