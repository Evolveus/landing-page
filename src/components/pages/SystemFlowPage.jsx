...
const STEPS = [
  ...
  { step: '04', title: 'Automated Evaluation', desc: 'Evaluate instantly with AI-powered accuracy. MCQ, LLM-based descriptive grading, coding test-case evaluation, and semantic fill-in-the-blank — all delivered without manual intervention.', tags: ['Descriptive', 'Coding', 'Semantic FIB'], icon: `<path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"/>`, active: true },
