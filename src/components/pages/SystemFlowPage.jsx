...
const STEPS = [
  { step: '01', title: 'Question Creation', desc: 'Build question banks across formats. Bulk-upload from Excel or let AI generate exam-ready questions from your syllabus.', tags: ['Bulk import', 'AI generation'], icon: `<path d="M17 3a2.828 2.828 0 114 4L7.5 20.5 2 22l1.5-5.5L17 3z"/>` },
  { step: '02', title: 'Exam Configuration', desc: 'Configure custom rules, patterns, and scoring. Set time limits, attempt restrictions, randomized ordering, and subnet-based access.', tags: ['Time limits', 'Randomization'], icon: `<circle cx="12" cy="12" r="3"/><path d="M19.07 4.93a10 10 0 010 14.14M4.93 4.93a10 10 0 000 14.14"/><path d="M15.54 8.46a5 5 0 010 7.07M8.46 8.46a5 5 0 000 7.07"/>` },
  { step: '03', title: 'Secure Exam', desc: 'Conduct exams in a secure, timed, proctored environment. Tab switches and unauthorized access are detected in real time.', tags: ['Proctoring', 'Kiosk mode'], icon: `<path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><path d="M9 12l2 2 4-4"/>` },
  { step: '04', title: 'Automated Evaluation', desc: 'Evaluate instantly with AI-powered accuracy. From objective scoring to LLM-based descriptive grading — results without manual intervention.', tags: ['MCQ', 'Descriptive'], icon: `<path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"/>`, active: true },
  { step: '05', title: 'Analytics & Insights', desc: 'Real-time insights with dashboards. Per-student breakdowns, class-wide trends, exportable reports — faculty act on data.', tags: ['Dashboards', 'Per-student'], icon: `<path d="M18 20V10M12 20V4M6 20v-6"/>` },
  { step: '06', title: 'Performance Optimization', desc: 'Use insights to improve outcomes and personalise learning. Identify weak areas and course-correct before they compound.', tags: ['Adaptive', 'Outcomes'], icon: `<path d="M4 15s1-1 4-1 5 2 8 2 4-1 4-1V3s-1 1-4 1-5-2-8-2-4 1-4 1z"/><path d="M4 22v-7"/>` },
];
