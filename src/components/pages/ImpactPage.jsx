      ...
      <div className="p7-stage">
        ...
        <div className="p7-hero">
          ...
          <p className="p7-hero-sub">
            420 descriptive papers, mid-term cycle, CS-301.<br />
            <span>The same rubric, the same defensible audit, the same faculty in the loop.</span>
          </p>
        </div>
        ...
        <div className="p7-close">
          <div className="p7-close-l">
            <div className="caption caption-light">Bring Evalify to your institution</div>
            <h2 className="p7-close-title">
              Book a 30-minute walkthrough.<br />
              <em>We'll tailor it to your departments.</em>
            </h2>
            <div className="p7-close-cta">
              <a href="#" className="p7-btn">Book a demo →</a>
              <a href="#" className="p7-btn-text">Download datasheet</a>
            </div>
          </div>
          ...
          <div className="p7-close-r">
            <div className="p7-contact-row">
              ...
              <span className="p7-contact-val">aksaykanthan@gmail.com</span>
            </div>
            <div className="p7-contact-row">
              <span className="p7-contact-key">Phone</span>
              <span className="p7-contact-val">+91 93447 69532</span>
            </div>
            <div className="p7-contact-row">
              <span className="p7-contact-key">Web</span>
              <span className="p7-contact-val">evalify.in</span>
            </div>
          </div>
        </div>
      </div>
