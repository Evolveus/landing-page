      ...
      <div className="p5-stage">
        <div className="p5-top">
          ...
          <h2 className="p5-headline">
            Where most platforms stop,<br />
            <em>Evalify begins.</em>
          </h2>
          <p className="p5-lede">
            Long-form descriptive answers are where manual grading hurts most —
            hours per paper, drift between graders, no audit trail. Faculty define
            mark-allocation guidelines per criterion; Evalify applies them at scale.
          </p>
        </div>
          ...
          <div className="p5-mock">
            ...
            <div className="p5-mock-body">
              ...
              <p className="p5-mock-a">
                A deadlock happens when two threads each hold a resource the other wants.
                The four conditions are mutual exclusion, hold and wait, no preemption, and
                circular wait. <span className="p5-mock-hi">Thread A locks file1 and asks for
                file2 while thread B locks file2 and asks for file1.</span>
              </p>

              <div className="p5-mock-eyebrow p5-mock-eyebrow--gap">RUBRIC — 3/4 met</div>
              <div className="p5-rubric">
                {RUBRIC.map(({ state, label, score }) => (
                  <div key={label} className="p5-rub-row">
                    <span className="p5-rub-tick" data-state={state}>{state === 'ok' ? '✓' : '~'}</span>
              ...
              <div className="p5-mock-foot">
                ...
                <span className="p5-mock-foot-r"><span>Score</span><strong>7 / 10</strong></span>
              </div>
            </div>
          </div>
          ...
          <aside className="p5-side">
            <div className="p5-side-block">
              ...
              <ol className="p5-steps">
                <li>
                  ...
                  <span>Criteria, weights, key points — set once, applied everywhere.</span>
                </li>
                <li>
                  <strong>LLM scores per criterion</strong>
                  <span>Each rubric line gets an independent score with rationale.</span>
                </li>
                <li>
                  <strong>Faculty reviews edge cases</strong>
                  <span>Borderline scores surface for review; clear ones land graded.</span>
                </li>
              </ol>
            </div>
            ...
            <div className="p5-side-block">
              ...
              <ul className="p5-bullets">
                <li>Semantic understanding — partial credit for partial reasoning, not keyword counting.</li>
                <li>Customisable rubrics per question — define criteria, weights, key concepts.</li>
                <li>Full audit trail — rubric, score, and rationale on every response. Defensible at appeal.</li>
              </ul>
            </div>
          </aside>
        </div>
