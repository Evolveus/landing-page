    ...
    <div className="page p2">
      ...
      <div className="p2-stage">
        ...
        <h2 className="p2-headline">
          The classroom moved on.<br />
          Most evaluation tools <em>didn't.</em>
        </h2>

        <p className="p2-lede dropcap">
          Modern institutions still stitch assessment together by hand —
          paper for some courses, half a dozen quiz apps for others, spreadsheets
          to glue it all back. It scales by adding people, not by adding intelligence.
          Evalify replaces that stack with a single platform built for evaluation
